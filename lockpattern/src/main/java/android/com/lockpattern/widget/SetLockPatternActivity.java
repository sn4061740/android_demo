...
import android.com.lockpattern.widget.LockPatternIndicator;
...
public class SetLockPatternActivity extends AppCompatActivity {
    ...
    private static ILockPatternListener lockPatternListener;

    public static void toClass(Context context, ILockPatternListener iLockPatternListener){
        Intent intent=new Intent(context,SetLockPatternActivity.class);
    ...
    public void onBackPressed() {
        Intent intent=new Intent();
        intent.putExtra("data","cancel_set");
