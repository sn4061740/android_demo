    ...
    public static class CdnItem implements Serializable {
        ...
        public String toString() {
            return "CdnItem{" +
                    ...
                    ", downSpeedTestList=" + downSpeedTestList +
                    ", ccList=" + ccList +
                    ", trackerList=" + trackerList +
                    ", m3U8List=" + m3U8List +
                    ", enableHTTP=" + enableHTTP +
                    ", defaultLine=" + defaultLine +
                    ", socketTestEnable=" + socketTestEnable +
                    ", playSpeedLogEnable=" + playSpeedLogEnable +
                    ", cacheLogEnable=" + cacheLogEnable +
                    ", apiErrorLogEnable=" + apiErrorLogEnable +
                    ", imageErrorLogEnable=" + imageErrorLogEnable +
                    ", testClientRunEnable=" + testClientRunEnable +
                    ", torrentMD5CheckEnable=" + torrentMD5CheckEnable +
                    ", umengErrorEnable=" + umengErrorEnable +
                    ", connectionCloseBoo=" + connectionCloseBoo +
                    ", imageWebPEnable=" + imageWebPEnable +
                    '}';
        }
